...
public class Physics2D {
    ...
    public Physics2D()
    {
        world.setContactListener(new RixxContactListener());
    }
    ...
    public void add(GameObject go)
    {
        ...
        if(rb != null && rb.getRawBody() == null)
        {
            ...
            if((stairCollider = go.getComponent(StairCollider.class)) != null)
            {
                addStairCollider(rb , stairCollider);
            }
    ...
    {
       Body body = rb.getRawBody();
       assert body != null : "Raw body must be null";
    ...
    public void resetBoxCollider(RigidBody2D rb , Box2DCollider box2DCollider)
    {
        Body body = rb.getRawBody();
        if(body == null) return;
    ...
    public void addStairCollider(RigidBody2D rb , StairCollider boxCollider)
    {
        Body body = rb.getRawBody();
        assert body != null : "Raw body must not be null";
        ...
        float offset = boxCollider.getOffset().y;

        if(boxCollider.isFacingRight())
        {
