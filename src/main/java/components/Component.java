    ...
    public void imgui()
    {
        try{
            ...
            for(Field field: fields){
                ...
                if(type == int.class){
                    int val = (int)value;
                    field.set(this, RImGui.dragInt(name, val) );
                }else if(type == float.class){
                    float val = (float)value;
                    field.set(this, RImGui.dragFloat(name, val) );
                ...
                else if (type == Vector2f.class )
                {
                    ...
                    RImGui.drawVec2Control(name, val);
                }
                ...
                {
                    field.set(this, RImGui.inputText(field.getName() + ": ", (String) value));
                }
