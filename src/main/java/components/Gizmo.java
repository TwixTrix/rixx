...
public class Gizmo extends Component{
    ...
    private Vector2f yAxisOffset = new Vector2f(-7f/80, 21/80f);
    ...
    private boolean checkXHoverState()
    {
        ...
        //TODO fix gizmo
        if(mousePos.x <= xAxisObject.transform.position.x  +(gizmoHeight /2.0f) && mousePos.x >= xAxisObject.transform.position.x - (gizmoHeight /2.0f) && mousePos.y >= xAxisObject.transform.position.y - (gizmoWidth/2f) && mousePos.y <= xAxisObject.transform.position.y + (gizmoWidth/2.0f) )
        {
