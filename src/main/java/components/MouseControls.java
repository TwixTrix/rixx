...
public class MouseControls extends Component {
    ...
    public void editorUpdate(float dt) {
        ...
        if (holdingObject != null  ) {
            ...
            if(holdingObject.transform.scale.y % .5f < .01f && holdingObject.transform.scale.y / .5f > .99f  )
            {
                holdingObject.transform.position.y = (int)(y/Settings.GRID_HEIGHT) * Settings.GRID_HEIGHT;
            ...
            if(holdingObject.transform.scale.x % .5f < .01f && holdingObject.transform.scale.x / .5f > .99f )
            {
                holdingObject.transform.position.x = (int)(x/Settings.GRID_WIDTH) * Settings.GRID_WIDTH;
